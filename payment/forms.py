...
class ShippingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['shipping_fullname', 'shipping_email', 'shipping_address1', 'shipping_address2',
...
class PaymentForm(forms.Form):
     ...
     card_exp_number = forms.DateField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Expiration Date'}), required=True)
